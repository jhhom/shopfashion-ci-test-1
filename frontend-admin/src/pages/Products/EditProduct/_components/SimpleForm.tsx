...
import {
  InputField,
  PricingField,
} from "~/pages/common/components/Form/InputField";
...
export function SimpleProductForm(props: {
  productData: {
    name: string;
    description: string;
    pricing: number;
      ...
      <Form
        ...
        options={{
          defaultValues: {
            ...
            pricing: props.productData.pricing,
          ...
          return (
            <>
              ...
              <ImageUploadField2
                ...
                currentImageUrl={props.productData.imageUrl}
