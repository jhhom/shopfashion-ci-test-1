...
import { KyselyDB } from "@backend/core/db";
import { seedReviews } from "@backend/scripts/seed3/seed/seed-reviews";
import { generateReviews } from "@backend/scripts/seed3/data/reviews";
